                ...
                <tr>
                    <td>
                        ...
                        <div class="col-sm-6">
                          ...
                          {!! Form::text('single_dpp', @num_format($variation->default_purchase_price), ['class' => 'form-control input-sm dpp input_number', 'required']); !!}
                        </div>
                    ...
                    <td>
                        ...
                        {!! Form::text('single_dsp', @num_format($variation->default_sell_price), ['class' => 'form-control input-sm dsp input_number', 'id' => 'single_dsp', 'required']); !!}
                        {!! Form::text('single_dsp_inc_tax', @num_format($variation->sell_price_inc_tax), ['class' => 'form-control input-sm hide input_number', 'id' => 'single_dsp_inc_tax', 'required']); !!}
                    </td>

                    <!-- ⭐ NEW PRODUCT KEYWORDS FIELD -->
                    <td>
                        {!! Form::label('product_keywords', 'Product Keywords:') !!}
                        {!! Form::text('product_keywords', $variation->product_keywords ?? null, [
                            ...
                            @foreach($variation->media as $media)
                                <div class="img-thumbnail">
                                    <span class="badge bg-red delete-media"
                                        data-href="{{ action([\App\Http\Controllers\ProductController::class, 'deleteMedia'], ['media_id' => $media->id]) }}">
